...
/*
  ...
  Returns:
    The return code - 0 on success, negative number (< 0) on error.
*/
extern int zip_extract_init_file(const char *zipname, const char *dir,
                       int (*on_extract_entry)(const char *filename, void *arg),
                       void *arg);


/*
Extracts a zip archive file into memory.
...
Args:
pMem: zip archive mem address.
size: zip init mem size
dir: output directory.
on_extract_entry: on extract callback.
arg: opaque pointer.
...
The return code - 0 on success, negative number (< 0) on error.
*/
extern int zip_extract_init_mem(const void *pMem, size_t size, const char *dir,
	int(*on_extract_entry)(const char *filename, void *arg),
	void *arg);
